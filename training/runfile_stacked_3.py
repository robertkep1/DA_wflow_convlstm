...
model=load_model('models/model_stacked_3')

opt = keras.optimizers.Adam(learning_rate=0.001)
model.compile(loss = 'mean_squared_error', optimizer = opt, metrics = 'mse')

mc = ModelCheckpoint('model_stacked_3.h5', monitor='val_loss', mode='min', save_best_only=True, verbose=1)
...
numpy.save('history_stacked_3.csv', array_hist)