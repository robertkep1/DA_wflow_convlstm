...
# load SS1 model
model = load_model('models/model_stacked_sep_1')
...
mc = ModelCheckpoint('model_stacked_sep_1.h5', monitor='val_loss', mode='min', save_best_only=True, verbose=1)
...
np.save('history_stacked_sep_1.csv', array_hist)